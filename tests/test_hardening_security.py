...
class HardeningSecurityTests(unittest.TestCase):
    ...
    def test_pwa_version_is_consistent_for_hardening_release(self):
        ...
        self.assertIn('"/index.html?v=10519"', worker)
        self.assertIn('"start_url": "/index.html?v=10519"', manifest)
        self.assertIn('version: "10519"', app_meta)
        self.assertIn('const CACHE_NAME = "matchiq-pwa-v119"', worker)
        self.assertIn('"/js/auth.js?v=10519"', worker)
        self.assertIn('"/js/safe-render.js?v=10519"', worker)
