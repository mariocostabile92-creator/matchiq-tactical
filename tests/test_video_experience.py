...
CONTRACT_CASES = [
    ...
    ("experience_css_asset", "html", '/css/video-experience.css?v=10542'),
    ("experience_js_asset", "html", '/js/video-experience.js?v=10542'),
    ("video_release", "html", 'const APP_VERSION = "10542"'),
    ...
    ("pwa_cache", "worker", 'const CACHE_NAME = "matchiq-pwa-v143"'),
    ("pwa_video_entry", "worker", '"/video.html?v=10542"'),
    ("pwa_css_entry", "worker", '"/css/video-experience.css?v=10542"'),
    ("pwa_intelligence_css_entry", "worker", '"/css/video-intelligence.css?v=10542"'),
    ("pwa_js_entry", "worker", '"/js/video-experience.js?v=10542"'),
    ("pwa_intelligence_js_entry", "worker", '"/js/video-intelligence.js?v=10542"'),
