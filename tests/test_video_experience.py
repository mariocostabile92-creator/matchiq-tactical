...
CONTRACT_CASES = [
    ...
    ("experience_css_asset", "html", '/css/video-experience.css?v=10536'),
    ("experience_js_asset", "html", '/js/video-experience.js?v=10536'),
    ("video_release", "html", 'const APP_VERSION = "10536"'),
    ...
    ("evidence_correct", "intelligence", 'data-action="correct">Salva correzione'),
    ("evidence_reject", "intelligence", 'data-action="reject">Scarta'),
    ("stable_queue_navigation", "intelligence", 'openMoment(item,false,false)'),
    ("desktop_workspace", "css", 'grid-template-columns:minmax(0,1fr) minmax(340px,420px)'),
    ("desktop_evidence_scroll", "css", 'max-height:calc(100dvh - 215px)'),
    ...
    ("pwa_cache", "worker", 'const CACHE_NAME = "matchiq-pwa-v136"'),
    ("pwa_video_entry", "worker", '"/video.html?v=10536"'),
    ("pwa_css_entry", "worker", '"/css/video-experience.css?v=10536"'),
    ("pwa_js_entry", "worker", '"/js/video-experience.js?v=10536"'),
