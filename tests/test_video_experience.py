...
CONTRACT_CASES = [
    ...
    ("processing_flow", "html", 'class="vx-processing-flow" aria-label="Attivita di analisi"'),
    ("workflow_context", "html", '<small class="vx-step-context">Organizza le evidenze</small>'),
    ("review_grid", "html", 'class="vx-review-grid"'),
    ("review_tools_disclosure", "html", 'class="vi-review-tools"'),
    ...
    ("experience_css_asset", "html", '/css/video-experience.css?v=10543'),
    ("experience_js_asset", "html", '/js/video-experience.js?v=10543'),
    ("video_release", "html", 'const APP_VERSION = "10543"'),
    ...
    ("evidence_details_disclosure", "intelligence", 'class="vi-evidence-details"'),
    ("media_adjustments_disclosure", "intelligence", 'class="vi-media-adjustments"'),
    ("stable_queue_navigation", "intelligence", 'openMoment(item,false,false)'),
    ("desktop_workspace", "css", 'grid-template-columns:minmax(0,1fr) minmax(288px,320px)'),
    ...
    ("pwa_js_entry", "worker", '"/js/video-experience.js?v=10543"'),
    ("pwa_intelligence_js_entry", "worker", '"/js/video-intelligence.js?v=10543"'),
