...
class MatchDayPolishTests(unittest.TestCase):
    def test_fifty_four_match_day_acceptance_scenarios(self):
        ...
        checks = [
            ...
            ("pwa cache release", 'const CACHE_NAME = "matchiq-pwa-v142"' in worker),
            ("pwa coach assets", all(x in worker for x in ("/coach.html?v=10542", "/css/coach.css?v=10534", "/js/coach-voice-actions.js?v=10534"))),
        ]
