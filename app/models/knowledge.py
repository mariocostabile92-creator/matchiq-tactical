...
class TeamProfileUpdate(KnowledgeModel):
    ...
    training_days: List[str] = Field(default_factory=list, max_length=7)
    training_duration: Optional[int] = Field(default=None, ge=30, le=180)
    match_day: Optional[str] = Field(default=None, max_length=30)
    pitch_type: Optional[str] = Field(default=None, max_length=120)
    pitch_dimensions: Optional[str] = Field(default=None, max_length=120)
    available_materials: List[str] = Field(default_factory=list, max_length=50)
    ...
    preferred_formation: Optional[str] = Field(default=None, max_length=40)
    average_intensity: Optional[str] = Field(default=None, max_length=30)
