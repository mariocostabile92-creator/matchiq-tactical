(function(){
  ...
  const labels={"/weekly-briefing.html":"Vedi briefing e fonti nella memoria tecnica","/pattern-intelligence.html":"Apri ricorrenze e timeline nella memoria","/training-planner.html":"Apri piano, fonti e versioni nella memoria","/coach.html":"Apri cronologia tecnica","/video.html":"Vedi sessioni e report nella memoria tecnica","/account.html":"Apri Memoria dello staff"};
  ...
  function addCompact(){
    ...
    const section=document.createElement("section");section.className="knowledge-entry";section.innerHTML=`<small>MEMORIA DELLO STAFF</small><h2>Memoria tecnica collegata</h2><p>Apri fonti, relazioni e cronologia senza modificare i dati originali.</p><a href="${href}">${labels[path]||"Apri memoria"}</a>`;
  ...
  async function addHome(){
    if(document.querySelector(".knowledge-entry"))return;
    const host=document.querySelector("main")||document.body;const section=document.createElement("section");section.className="knowledge-entry";section.innerHTML='<small>MEMORIA DELLO STAFF</small><h2>La memoria tecnica della squadra</h2><p id="knowledgeHomeText">Carico gli elementi collegati...</p><a href="/knowledge.html">Apri memoria</a>';
