(async function bootWeeklyBriefing(){
  const W=window.MatchIQWeekly;if(!W.authToken()){document.getElementById("weeklyLoading").textContent="Accedi per preparare la tua settimana.";document.getElementById("weeklyLogin").hidden=false;return;}
