(function initHomeState(){
  ...
  H.state = {
    ...
    user: null,
    remote: {stats:{}, stats_available:{}, continue_items:[], activities:[], ai_priorities:[], weekly_priorities:[], section_errors:[]},
  ...
  H.mergeData = function(){
    ...
    H.state.view = {
      ...
      weeklyPriorities:Array.isArray(remote.weekly_priorities)?remote.weekly_priorities:[],
      hero:today.hero,
