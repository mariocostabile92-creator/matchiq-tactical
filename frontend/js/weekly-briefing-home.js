(async function showWeeklyBriefingOnHome(){
  ...
  try{
    ...
    const main=document.getElementById("homeMain");if(!main||document.getElementById("weeklyHomeBanner"))return;
    ...
    const action=document.createElement("a");action.href="/weekly-briefing.html";action.textContent="Apri";banner.append(copy,action);main.insertBefore(banner,main.children[1]||null);
