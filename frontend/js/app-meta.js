...
(function initMatchIqLegalUi(){
    ...
    function injectDecisionEntryAssets(){
        ...
        const style=document.createElement("link"); style.rel="stylesheet"; style.href="/css/decision-engine-entry.css?v=10528"; document.head.appendChild(style);
        const script=document.createElement("script"); script.src="/js/decision-engine-entry.js?v=10528"; script.defer=true; document.body.appendChild(script);
    }
    ...
    function injectClubEntryAssets(){
        ...
        const style=document.createElement("link"); style.rel="stylesheet"; style.href="/css/club-intelligence-entry.css?v=10528"; document.head.appendChild(style);
        const script=document.createElement("script"); script.src="/js/club-intelligence-entry.js?v=10528"; script.defer=true; document.body.appendChild(script);
    }
