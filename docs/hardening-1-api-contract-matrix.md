...
Aprire poi `http://127.0.0.1:8793/index.html?v=10516`, DevTools Console/Application e completare le checklist dispositivo/provider sopra.

## Contratti frontend Hardening 3

| Contratto | Evidenza | Stato |
|---|---|---|
| Release unica | tutte le query asset `10516` | `fixed_in_hardening_3` |
| Cache PWA unica | `matchiq-pwa-v116` | `fixed_in_hardening_3` |
