...
- Manifest valido, scope `/`, display standalone e start URL aggiornato a `10518`.
- Cache aggiornata a `matchiq-pwa-v118`.
...
- Release frontend unica portata a `10518`; cache PWA portata a `matchiq-pwa-v118`.
