...
- Manifest valido, scope `/`, display standalone e start URL aggiornato a `10522`.
- Cache aggiornata a `matchiq-pwa-v122`.
...
- Release frontend unica portata a `10522`; cache PWA portata a `matchiq-pwa-v122`.
