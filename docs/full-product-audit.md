...
- Manifest valido, scope `/`, display standalone e start URL aggiornato a `10516`.
- Cache aggiornata a `matchiq-pwa-v116`.
...
- Release frontend unica portata a `10516`; cache PWA portata a `matchiq-pwa-v116`.
