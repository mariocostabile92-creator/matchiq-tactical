...
- Manifest valido, scope `/`, display standalone e start URL aggiornato a `10521`.
- Cache aggiornata a `matchiq-pwa-v121`.
...
- Release frontend unica portata a `10521`; cache PWA portata a `matchiq-pwa-v121`.
