...
- Manifest valido, scope `/`, display standalone e start URL aggiornato a `10520`.
- Cache aggiornata a `matchiq-pwa-v120`.
...
- Release frontend unica portata a `10520`; cache PWA portata a `matchiq-pwa-v120`.
