...
- Manifest valido, scope `/`, display standalone e start URL aggiornato a `10519`.
- Cache aggiornata a `matchiq-pwa-v119`.
...
- Release frontend unica portata a `10519`; cache PWA portata a `matchiq-pwa-v119`.
