...
- Manifest valido, scope `/`, display standalone e start URL aggiornato a `10517`.
- Cache aggiornata a `matchiq-pwa-v117`.
...
- Release frontend unica portata a `10517`; cache PWA portata a `matchiq-pwa-v117`.
